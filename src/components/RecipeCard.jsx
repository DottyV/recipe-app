...
const RecipeCard = ({recipe, bg, badge}) => {
    ...
    const [isFavourite, setIsFaourite] = useState(localStorage.getItem('favourites')?.includes(recipe.label));

    const addRecipeToFavs = () => {
        let favourites = JSON.parse(localStorage.getItem('favourites')) || [];
        const isRecipeAlreadyInFavs = favourites.some((fav) => fav.label === recipe.label);

        if (isRecipeAlreadyInFavs) {
